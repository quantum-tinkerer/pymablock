...
Because our goal is to find the frequency shift of the transmon's lowest
...
call \mintinline{python}|block_diagonalize| for each state separately,
...
\mintinline{python}|subspace_indices| to assign the elements of its eigenbasis
...
\mintinline{python}|subspace_indices| accordingly, and we obtain the following:
%
\begin{align}
...
\mintinline{python}|H_tilde[0, 0, :n]| to the desired order $n$.
