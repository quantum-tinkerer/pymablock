...
To design Pymablock's algorithm, we consider scenarios in which an efficient
...
analytical effective model is essential to interpreting their behavior, because
it provides a clear dependence of dispersive shifts, effective couplings, and
parasitic crosstalk couplings on the circuit's
parameters~\cite{Li_2020,Sete_2021}.
The same holds for circuit QED systems overall, for which computational tools
are being actively developed~\cite{GrosGroszkowski_2021, Chitta_2022, Li_2022}.
...
a k.p model is used, and Majorana devices~\cite{Melo_2023}, and quantum dot
arrays.
