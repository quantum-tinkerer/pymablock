...
\end{minted}
%
Querying \mintinline{python}{H_tilde} returns the results in a masked numpy array, so we
define \mintinline{python}{H_tilde_AA} to gather different entries into one symbolic expression.
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{figures/benchmark_lattice.pdf}
