...
\co{A standard approach to construct the effective model is the Schrieffer-Wolff algorithm.}
...
superconducting circuits, quantum dot physics. \todo[inline]{add citations and maybe a couple more examples}
...
Constructing effective Hamiltonians is, however, both algorithmically
