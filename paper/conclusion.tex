...
\co{We have developed an efficient algorithm to construct effective Hamiltonians
...
\co{Pymablock is a versatile tool that can be further developed to tackle
