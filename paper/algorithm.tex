...
give rise to a different recursive procedure for the algorithm.
...
most computationally efficient and that gives the most compact results.
...
\end{align}
%
where series multiply according to the
\href{https://en.wikipedia.org/wiki/Cauchy_product}{Cauchy product}:
%
$$
...
\textbf{Computational complexity of the Cauchy product}
...
\begin{itemize}
    ...
    (see \href{https://en.wikipedia.org/wiki/Perturbation_theory_(quantum_mechanics)#Time-independent_perturbation_theory}{here}).
