...
\end{equation}
Together with the series $\mathcal{U}'$ Eqs.~(\ref{eq:W},\ref{eq:sylvester_optimized}), $\mathcal{A} = \mathcal{H}'_{O}\mathcal{U}'$, $\mathcal{B}$ Eqs.~(\ref{eq:B_diag},\ref{eq:B_offdiag}) this equation defines the optimized algorithm.
