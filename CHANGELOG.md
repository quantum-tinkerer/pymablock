...
- Made hashes of equal `NumberOrderedForm` expressions independent of unused operators and stored term order, restoring set and dictionary lookup.
...
- Dropped support for Python 3.11, numpy 1.26, and scipy 1.12 according to the [SPEC-0](https://scientific-python.org/specs/spec-0000/).
