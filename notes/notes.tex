...
There is, however, a combinatorical factor in the number of terms involved in these expressions, which grows exponentially with $n$.
These factors are even larger if there are multiple small parameters in the expansion.
We defer in-depth analysis of the complexity of high order expansions for now.
