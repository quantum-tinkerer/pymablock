...
def block_diagonalize(
    ...
    *,
    ...
    subspace_eigenvectors: Eigenvectors | Embedding | None = None,
    ...
    subspace_eigenvectors :
        ...
        basis columns to describe a target operator algebra and occupation rules.
        If neither
        ...
        return np.vstack(
            [
                greens_function(
                    ...
                    solver_options.get("max_moments", 1_000_000),
                )
