...
def _assert_roundtrip(
    ...
    compare_series(cauchy_dot_product(U_inv, H, U), H_tilde, wanted_orders, atol=1e-12)
    compare_series(cauchy_dot_product(U, H_tilde, U_inv), H, wanted_orders, atol=1e-12)
    return H_tilde
